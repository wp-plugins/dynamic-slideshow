...
function uds_init()
{
	...
	if(is_admin()){
		add_thickbox();
		$cssdir = "/wp-content/plugins/dynamic-slideshow/css/";
...
function uds_styles()
{
    ...
    $image = createThumbs(get_bloginfo('url')."/wp-content/plugins/dynamic-slideshow/images/billboard-shadow.jpg",$uploades['basedir']."/billboardShadow.jpg", $width);
	$cssdir = "/wp-content/plugins/dynamic-slideshow/css/";
	if(!is_admin()){
...
{
	$jsdir = "/wp-content/plugins/dynamic-slideshow/js/";
